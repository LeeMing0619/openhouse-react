          ...
          <View style={{ width: '80%', backgroundColor: 'white', borderRadius: 10}}>
            ...
            <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'center', marginBottom: 20, flexWrap: 'wrap' }}>
              <View style={[styles.imgcontainer, { width: '40%' }]}>
                <Button style={[styles.btn, { height: 120, justifyContent: 'center' }]} onPress={() => this.asapbtn()}>
                  <Text style={[{ color: 'white', fontSize: 35, paddingLeft: 20 }]}>ASAP</Text>
                </Button>
              </View>
              <View style={[styles.imgcontainer, { width: '40%' }]}>
                <Button style={[styles.btn, { height: 120, justifyContent: 'center' }]} onPress={() => this.threebtn()}>
                  <Text style={[{ color: 'white', fontSize: 35, paddingLeft: 20 }]}>3 MONTHS</Text>
                </Button>
              </View>
              <View style={[styles.imgcontainer, { width: '40%' }]}>
                <Button style={[styles.btn, { height: 120, justifyContent: 'center' }]} onPress={() => this.sixbtn()}>
                  <Text style={[{ color: 'white', fontSize: 35, paddingLeft: 20 }]}>6 MONTHS</Text>
                </Button>
              </View>
              <View style={[styles.imgcontainer, { width: '40%' }]}>
                <Button style={[styles.btn, { height: 120, justifyContent: 'center' }]} onPress={() => this.twelvebtn()}>
                  <Text style={[{ color: 'white', fontSize: 35, paddingLeft: 20 }]}>12 MONTHS</Text>
                </Button>
              </View>
            </View>
          </View>
