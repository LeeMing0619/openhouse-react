          ...
          <View style={{ width: '80%', backgroundColor: 'white', borderRadius: 10 }}>
            ...
            <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'center', marginBottom: 20, flexWrap: 'wrap' }}>
              <View style={[styles.imgcontainer, { width: '40%' }]}>
                <Button style={[styles.btn, { height: 120, justifyContent: 'center' }]} onPress={() => this.internetbtn()}>
                  <Text style={[{ color: 'white', fontSize: 35, paddingLeft: 20 }]}>INTERNET</Text>
                </Button>
              </View>
              <View style={[styles.imgcontainer, { width: '40%' }]}>
                <Button style={[styles.btn, { height: 120, justifyContent: 'center' }]} onPress={() => this.newspaperbtn()}>
                  <Text style={[{ color: 'white', fontSize: 35, paddingLeft: 20 }]}>NEWSPAPER</Text>
                </Button>
              </View>
              <View style={[styles.imgcontainer, { width: '40%' }]}>
                <Button style={[styles.btn, { height: 120, justifyContent: 'center' }]} onPress={() => this.signoutsidebtn()}>
                  <Text style={[{ color: 'white', fontSize: 35, paddingLeft: 20 }]}>SIGN OUTSIDE</Text>
                </Button>
              </View>
              <View style={[styles.imgcontainer, { width: '40%' }]}>
                <Button style={[styles.btn, { height: 120, justifyContent: 'center' }]} onPress={() => this.otherbtn()}>
                  <Text style={[{ color: 'white', fontSize: 35, paddingLeft: 20 }]}>OTHER</Text>
                </Button>
              </View>
            </View>
          </View>
