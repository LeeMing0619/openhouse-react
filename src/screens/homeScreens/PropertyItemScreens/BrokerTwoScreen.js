          ...
          <View style={{ width: '80%', backgroundColor: 'white', borderRadius: 10 }}>
            ...
            <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'center', marginBottom: 20, flexWrap: 'wrap' }}>
              <View style={[styles.imgcontainer, { width: '40%' }]}>
                <Button style={[styles.btn, { height: 120, justifyContent: 'center' }]} onPress={() => this.inlinebtn()}>
                  <Text style={[{ color: 'white', fontSize: 35, paddingLeft: 20 }]}>Inline with area</Text>
                </Button>
              </View>
              <View style={[styles.imgcontainer, { width: '40%' }]}>
                <Button style={[styles.btn, { height: 120, justifyContent: 'center' }]} onPress={() => this.overpricebtn()}>
                  <Text style={[{ color: 'white', fontSize: 35, paddingLeft: 20 }]}>Over Price</Text>
                </Button>
              </View>
              <View style={[styles.imgcontainer, { width: '40%' }]}>
                <Button style={[styles.btn, { height: 120, justifyContent: 'center' }]} onPress={() => this.underpricebtn()}>
                  <Text style={[{ color: 'white', fontSize: 35, paddingLeft: 20 }]}>Under Price</Text>
                </Button>
              </View>
              <View style={[styles.imgcontainer, { width: '40%' }]}>
                <Button style={[styles.btn, { height: 120, justifyContent: 'center' }]} onPress={() => this.perfectbtn()}>
                  <Text style={[{ color: 'white', fontSize: 35, paddingLeft: 20 }]}>Perfect</Text>
                </Button>
              </View>
            </View>
          </View>
