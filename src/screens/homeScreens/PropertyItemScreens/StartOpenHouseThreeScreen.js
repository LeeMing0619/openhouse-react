          ...
          <View style={{ width: '80%', backgroundColor: 'white',borderRadius:10 }}>
            ...
            <View style={{width:'100%' ,flexDirection: 'row', justifyContent:'center',marginBottom: 20, flexWrap:'wrap'}}>
              <View style={[styles.imgcontainer, { width: '40%' }]}>
                <Button style={[styles.btn, { height: 120, justifyContent:'center'}]} onPress={() => this.buyerbtn()}>
                  {this.props.dashboard.selectedproperty.property_type === 'R' ? (
                    <Text style={{color:'white', fontSize:35}}>A POTENTIAL TENTANT</Text>
                  ) : (
                      <Text style={{color:'white', fontSize:35}}>A POTENTIAL BUYER</Text>
                    )}
                </Button>
              </View>
              <View style={[styles.imgcontainer, { width: '40%' }]}>
                <Button style={[styles.btn, { height: 120, justifyContent:'center'}]} onPress={() => this.agentbtn()}>
                  <Text style={[{color:'white', fontSize:35}]}>REAL ESTATE AGENT</Text>
                </Button>
              </View>
            </View>
          </View>
