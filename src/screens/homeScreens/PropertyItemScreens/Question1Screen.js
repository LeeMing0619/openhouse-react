    ...
    if (Constants.device_Pad) {
      return (
        <ImageBackground
          ...
          resizeMode="cover">
          <View style={styles.header} onLayout={this._onLayout}>
            <TouchableOpacity
          ...
          <View style={{ width: '80%', backgroundColor: 'white', borderRadius: 10 }}>
            ...
            <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'center', marginBottom: 20, flexWrap: 'wrap' }}>
              <View style={[styles.imgcontainer, { width: '40%' }]}>
                <Button style={[styles.btn, { height: 120, justifyContent:'center' }]} onPress={() => this.ownahousebtn()}>
                      <Text style={[{ color: 'white', fontSize: 35, paddingLeft: 20 }]}>OWN A HOUSE</Text>
                </Button>
              </View>
              <View style={[styles.imgcontainer, { width: '40%' }]}>
                <Button style={[styles.btn, { height: 120, justifyContent:'center' }]} onPress={() => this.rentapropertybtn()}>
                  <Text style={[{ color: 'white', fontSize: 35, paddingLeft: 20 }]}>RENT A PROPERTY</Text>
                </Button>
              </View>
            </View>
          </View>
...
function mapDispatchToProps(dispatch) {
  return bindActionCreators({
    questionStatus: Actions.QuestionStatus,
  }, dispatch);
}
