...
class BuyerNoActivity extends Component {
  ...
  continue = () => {
    ...
    if (!attendeefirstname || attendeefirstname.length < 3) {
      ...
      // this.setState({deviceID: true});
      Constants.backScreen = 'buyerNoActivity';

      if (Constants.checkArray[0] == 1) {
        this.props.navigation.navigate('question1Screen',{'value': '1'});
      } else {
        var flag = 0;
        var position = 0;
  ...
  render() {
    if (this.deviceID) {
      ...
      //         <Text style={{ fontSize: 40, marginTop: 5, marginBottom: 5, fontWeight: 'bold' }}>
      ...
      //         </Item>
      //         <Item stackedLabel style={styles.txtviewitem}>
      //           <Text style={[styles.txtitem,{fontSize:18}]}>
